  ...
  const destinations = [
    {
      name: "Moon",
      images: {
        png: require('/src/assets/destination/image-moon.png'),
        webp: require("/src/assets/destination/image-moon.webp"),
      },
      description:
    ...
    },
    {
      name: "Mars",
      images: {
        png: require("/src/assets/destination/image-mars.png"),
        webp: require("/src/assets/destination/image-mars.webp"),
      },
      description:
    ...
    },
    {
      name: "Europa",
      images: {
        png: require("/src/assets/destination/image-europa.png"),
        webp:require("/src/assets/destination/image-europa.webp"),
      },
      description:
    ...
    },
    {
      name: "Titan",
      images: {
        png: require("/src/assets/destination/image-titan.png"),
