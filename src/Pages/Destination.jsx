...
const Destination = () => {
  ...
  return (
    <div className=  "laptop:bg-[url('/assets/destination/background-destination-desktop.jpg')]  tablet:bg-[url('/assets/destination/background-destination-tablet.jpg)] bg-[url('/assets/destination/background-destination-mobile.jpg')] bg-cover min-h-screen w-full bg-no-repeat">
